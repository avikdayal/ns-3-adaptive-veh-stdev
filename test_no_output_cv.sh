#!/bin/bash
./waf --run "scratch/wave-bsm-risk_cv --protocol=0 --totaltime=60 --nodes=20"
...
./waf --run "scratch/wave-bsm-risk_cv --protocol=0 --totaltime=60 --nodes=40"
./waf --run "scratch/wave-bsm-risk_cv --protocol=0 --totaltime=60 --nodes=80"
...
./waf --run "scratch/wave-bsm-risk_cv --protocol=0 --totaltime=60 --nodes=160"
