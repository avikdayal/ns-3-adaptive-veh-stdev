...
#ifndef WAVE_BSM_HELPER_AVIK_H
#define WAVE_BSM_HELPER_AVIK_H
...
public:
  ...
  */
  ...
  Ptr<WaveBsmStats> GetWaveBsmStats_hp ();
  /**
...
private:
  ...
  WaveBsmStats m_waveBsmStats_hp; ///< wave BSM stats
