...
figure('rend','painters','pos',[10 10 700 500]);plot(safety_range(1:7), twin_20_lp,'-or');title('T-window Adaptive Packet Probability vs Distance');xlabel('Distance (m)');ylabel('T-Window Probability');
hold on;
