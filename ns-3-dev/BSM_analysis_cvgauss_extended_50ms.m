...
load lp_PDR_SR_1_control;
load lp_PDR_SR_3_control;
load lp_PDR_SR_5_control;
load lp_PDR_SR_7_control;

load hp_PDR_SR_1_50ms;
load hp_PDR_SR_3_50ms;
load hp_PDR_SR_5_50ms;
load hp_PDR_SR_7_50ms;
load lp_PDR_SR_1_50ms;
load lp_PDR_SR_3_50ms;
load lp_PDR_SR_5_50ms;
load lp_PDR_SR_7_50ms;
...
fileID_50ms = fopen(filename_20n_50ms,'r');
fileID_40n_50ms = fopen(filename_40n_50ms,'r');
fileID_60n_50ms = fopen(filename_60n_50ms,'r');
fileID_70n_50ms = fopen(filename_70n_50ms,'r');
fileID_80n_50ms = fopen(filename_80n_50ms,'r');
fileID_90n_50ms = fopen(filename_90n_50ms,'r');
fileID_100n_50ms = fopen(filename_100n_50ms,'r');
fileID_120n_50ms = fopen(filename_120n_50ms,'r');
fileID_160n_50ms = fopen(filename_160n_50ms,'r');

fileID_2_50ms = fopen(filename_20n_2_50ms,'r');
fileID_40n_2_50ms = fopen(filename_40n_2_50ms,'r');
fileID_60n_2_50ms = fopen(filename_60n_2_50ms,'r');
fileID_70n_2_50ms = fopen(filename_70n_2_50ms,'r');
fileID_80n_2_50ms = fopen(filename_80n_2_50ms,'r');
fileID_90n_2_50ms = fopen(filename_90n_2_50ms,'r');
fileID_100n_2_50ms = fopen(filename_100n_2_50ms,'r');
fileID_120n_2_50ms = fopen(filename_120n_2_50ms,'r');
fileID_160n_2_50ms = fopen(filename_160n_2_50ms,'r');
...
dataArray_50ms = textscan(fileID_50ms, formatSpec, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_40n_50ms = textscan(fileID_40n_50ms, formatSpec_40n, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_60n_50ms = textscan(fileID_60n_50ms, formatSpec_40n, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_70n_50ms = textscan(fileID_70n_50ms, formatSpec_40n, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_80n_50ms = textscan(fileID_80n_50ms, formatSpec_80n, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_90n_50ms = textscan(fileID_90n_50ms, formatSpec_80n, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_100n_50ms = textscan(fileID_100n_50ms, formatSpec_80n, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_120n_50ms = textscan(fileID_120n_50ms, formatSpec_160n, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_160n_50ms = textscan(fileID_160n_50ms, formatSpec_160n, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');

dataArray_2_50ms = textscan(fileID_2_50ms, formatSpec_2, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_40n_2_50ms = textscan(fileID_40n_2_50ms, formatSpec_2, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_60n_2_50ms = textscan(fileID_60n_2_50ms, formatSpec_2, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_70n_2_50ms = textscan(fileID_70n_2_50ms, formatSpec_2, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_80n_2_50ms = textscan(fileID_80n_2_50ms, formatSpec_2, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_90n_2_50ms = textscan(fileID_90n_2_50ms, formatSpec_2, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_100n_2_50ms = textscan(fileID_100n_2_50ms, formatSpec_2, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_120n_2_50ms = textscan(fileID_120n_2_50ms, formatSpec_2, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
dataArray_160n_2_50ms = textscan(fileID_160n_2_50ms, formatSpec_2, 'Delimiter', delimiter, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
...
figure('rend','painters','pos',[10 10 1050 750]);plot(density, hp_PDR_SR_3,'-og');title('High Priority Packet Delivery Ratio vs Node Density');xlabel('Density(nodes/km)');ylabel('Packet Delivery Ratio');
hold on;
%plot(density, hp_PDR_SR_3,'-ob');
plot(density, hp_PDR_SR_5,'-ok');
%plot(density, hp_PDR_SR_7,'-og');
%plot(density, hp_PDR_SR_1_control,'-.xr');
plot(density, hp_PDR_SR_3_control,'-.m');
plot(density, hp_PDR_SR_5_control,'-.c');
plot(density, hp_PDR_SR_3_50ms,'-.xb');
plot(density, hp_PDR_SR_5_50ms,'-.xr');
%plot(density, hp_PDR_SR_7_control,'-.xg');
ylim([0.05 1.01])
set(findall(gcf,'-property','FontSize'),'FontSize',24)
%legend('20 nodes-.1 sec beacon rate','40 nodes-.1 sec beacon rate','80 nodes-.1 sec beacon rate','160 nodes-.1 sec beacon rate','20 nodes-.05 sec beacon rate','40 nodes-.05 sec beacon rate','80 nodes-.05 sec beacon rate','160 nodes-.05 sec beacon rate');
legend( [num2str(safety_range(3)) ' m range- 10 Hz Adaptive Rate Simulation-HP Messages'], [num2str(safety_range(4)) ' m range-10 Hz Adaptive Rate Simulation-HP Messages'], ...
[num2str(safety_range(3)) ' m range-Constant Rate Simulation-HP Messages'], [num2str(safety_range(4)) ' m range-Constant Rate Simulation-HP Messages'], ...
[num2str(safety_range(3)) ' m range-20 Hz Adaptive Rate Simulation-HP Messages'], [num2str(safety_range(4)) ' m range-20 Hz Adaptive Rate Simulation-HP Messages']);
hold off;


figure('rend','painters','pos',[10 10 1050 750]);plot(density, lp_PDR_SR_3,'-og');title('Low Priority Packet Delivery Ratio vs Node Density');xlabel('Density(nodes/km)');ylabel('Packet Delivery Ratio');
hold on;
%plot(density, hp_PDR_SR_3,'-ob');
plot(density, lp_PDR_SR_5,'-ok');
%plot(density, hp_PDR_SR_7,'-og');
%plot(density, hp_PDR_SR_1_control,'-.xr');
plot(density, lp_PDR_SR_3_control,'-.m');
plot(density, lp_PDR_SR_5_control,'-.c');
plot(density, lp_PDR_SR_3_50ms,'-.xb');
plot(density, lp_PDR_SR_5_50ms,'-.xr');
%plot(density, hp_PDR_SR_7_control,'-.xg');
ylim([0.05 1.01])
set(findall(gcf,'-property','FontSize'),'FontSize',24)
%legend('20 nodes-.1 sec beacon rate','40 nodes-.1 sec beacon rate','80 nodes-.1 sec beacon rate','160 nodes-.1 sec beacon rate','20 nodes-.05 sec beacon rate','40 nodes-.05 sec beacon rate','80 nodes-.05 sec beacon rate','160 nodes-.05 sec beacon rate');
legend( [num2str(safety_range(3)) ' m range-10 Hz Adaptive Rate Simulation-LP Messages'], [num2str(safety_range(4)) ' m range-10 Hz Adaptive Rate Simulation-LP Messages'], ...
[num2str(safety_range(3)) ' m range-Constant Rate Simulation-LP Messages'], [num2str(safety_range(4)) ' m range-Constant Rate Simulation-LP Messages'], ...
[num2str(safety_range(3)) ' m range-20 Hz Adaptive Rate Simulation-LP Messages'], [num2str(safety_range(4)) ' m range-20 Hz Adaptive Rate Simulation-LP Messages']);
hold off;
