...
filename_20n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_20node_5sec.output2.csv';
filename_40n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_40node_5sec.output2.csv';
filename_60n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-raten/ns-3-dev/bsm_60node_5sec.output2.csv';
filename_80n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_80node_5sec.output2.csv';
filename_160n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_160node_5sec.output2.csv';
delimiter = ',';
startRow = 2;
...
%% Initialize variables.
filename_20n_control = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-RA-simulation/ns-3-dev/bsm_control_20node.output2.csv';
filename_40n_control = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-RA-simulation/ns-3-dev/bsm_control_40node.output2.csv';
filename_60n_control = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-RA-simulation/ns-3-dev/bsm_control_60node.output2.csv';
filename_80n_control = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-RA-simulation/ns-3-dev/bsm_control_80node.output2.csv';
filename_160n_control = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-RA-simulation/ns-3-dev/bsm_control_160node.output2.csv';
delimiter = ',';
startRow = 2;
...
plot(safety_range(1:7), lp_PDR_control(1:7),'-.xr');%title('Packet Delivery Ratio vs Distance Control');xlabel('Distance (m^2)');ylabel('Packet Delivery Ratio');
%hold on;
plot(safety_range(1:7), lp_PDR_40n_control(1:7),'-.xb');
plot(safety_range(1:7), lp_PDR_80n_control(1:7),'-.xk');
plot(safety_range(1:7), lp_PDR_160n_control(1:7),'-.xg');
legend('20 nodes-Risk Scheme-Safe Nodes','40 nodes--Risk Scheme-Safe Nodes','80 nodes--Risk Scheme-Safe Nodes',...
    '160 nodes--Risk Scheme-Safe Nodes','20 nodes-Control Scheme-Safe Nodes','40 nodes-Control Scheme-Safe Nodes',...
    '80 nodes-Control Scheme-Safe Nodes','160 nodes-Control Scheme-Safe Nodes');
hold off;
figure;
plot(safety_range(1:7), hp_PDR(1:7),'-or');title('Packet Delivery Ratio vs Distance');xlabel('Distance (m^2)');ylabel('Packet Delivery Ratio');
hold on;
plot(safety_range(1:7), hp_PDR_40n(1:7),'-ob');
plot(safety_range(1:7), hp_PDR_80n(1:7),'-ok');
plot(safety_range(1:7), hp_PDR_160n(1:7),'-og');
...
legend('20 nodes-Risk Scheme-At Risk Nodes','40 nodes-Risk Scheme-At Risk Nodes','80 nodes--Risk Scheme-At Risk Nodes',...
...
% legend('20 nodes-.1 sec beacon rate','40 nodes-.1 sec beacon rate','80 nodes-.1 sec beacon rate',...
%     '160 nodes-.1 sec beacon rate','20 nodes-.05 sec beacon rate','40 nodes-.05 sec beacon rate',...
%     '80 nodes-.05 sec beacon rate','160 nodes-.05 sec beacon rate',...
%     '20 nodes-Safe Nodes','40 nodes-Safe Nodes','80 nodes-Safe Nodes',...
%     '160 nodes-Safe Nodes','20 nodes-At Risk Nodes','40 nodes-At Risk Nodes',...
%     '80 nodes-At Risk Nodes','160 nodes-At Risk Nodes');
