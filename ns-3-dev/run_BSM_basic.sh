...
./waf --run "scratch/vanet-routing-compare --protocol=0 --totaltime=60 --nodes=10 --CSVfileName=npbsm_10node.output.csv --CSVfileName2=npbsm_10node.output.csv"
...
./waf --run "scratch/vanet-routing-compare --protocol=0 --totaltime=60 --nodes=50 --CSVfileName=npbsm_50node.output.csv --CSVfileName2=npbsm_50node.output.csv"
...
./waf --run "scratch/vanet-routing-compare --protocol=0 --totaltime=60 --nodes=100 --CSVfileName=npbsm_100node.output.csv --CSVfileName2=npbsm_100node.output.csv"
