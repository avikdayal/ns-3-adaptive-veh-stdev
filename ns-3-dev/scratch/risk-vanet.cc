...
#include "VanetRoutingExperiment.h"
#include  "PriorityRoutingExperiment.h"
...
void
VanetRoutingExperiment::OverrideConfigs()
{
...
VanetRoutingExperiment::SetConfigFromGlobals ()
{
  ...
  NS_LOG_UNCOND ("SetConfigfromGlobals " << m_scenario);
...
VanetRoutingExperiment::SetGlobalsFromConfig ()
{
  ...
  NS_LOG_UNCOND ("SetGlobal " << m_scenario);
...
VanetRoutingExperiment::CommandSetup (int argc, char **argv)
{
  ...
  NS_LOG_UNCOND ("CmdAddvalue " << m_scenario);
...
VanetRoutingExperiment::SetupScenario ()
{
  ...
  NS_LOG_UNCOND ("SetupScenario " << m_scenario);
}
...
PriorityRoutingExperiment::PriorityRoutingExperiment() : VanetRoutingExperiment()
{
	VanetRoutingExperiment::m_traceFile = "";
	VanetRoutingExperiment::m_logFile = "";
	VanetRoutingExperiment::m_mobility = 2;
   	VanetRoutingExperiment::m_nNodes = 40;
   	VanetRoutingExperiment::m_TotalSimTime = 10.0;
   	//VanetRoutingExperiment::m_scenario=1;
   	NS_LOG_UNCOND ("AVIK PriorityRoutingExperiment " << m_nNodes);
}

PriorityRoutingExperiment::~PriorityRoutingExperiment()
{

}

void
PriorityRoutingExperiment::ProcessOutputs ()
{
  // calculate and output final results
  double bsm_pdr1 = m_waveBsmHelper.GetWaveBsmStats ()->GetCumulativeBsmPdr (1);
  double bsm_pdr2 = m_waveBsmHelper.GetWaveBsmStats ()->GetCumulativeBsmPdr (2);
  ...
  if (m_log != 0)
    {
      NS_LOG_UNCOND ("Avik test: BSM_PDR1=" << bsm_pdr1 << " BSM_PDR2=" << bsm_pdr2 << " BSM_PDR3=" << bsm_pdr3 << " BSM_PDR4=" << bsm_pdr4 << " BSM_PDR5=" << bsm_pdr5 << " BSM_PDR6=" << bsm_pdr6 << " BSM_PDR7=" << bsm_pdr7 << " BSM_PDR8=" << bsm_pdr8 << " BSM_PDR9=" << bsm_pdr9 << " BSM_PDR10=" << bsm_pdr10 << " Goodput=" << averageRoutingGoodputKbps << "Kbps MAC/PHY-oh=" << mac_phy_oh);
...
void PriorityRoutingExperiment::SetDefaultAttributeValues ()
{
	VanetRoutingExperiment::SetDefaultAttributeValues();
	NS_LOG_UNCOND ("PriorityRoutingExperiment::SetDefaultAttributeValues " << m_nNodes);
}
void
PriorityRoutingExperiment::OverrideConfigs()
{
	/***
	VanetRoutingExperiment::m_nNodes = 99;
	VanetRoutingExperiment::m_TotalSimTime = 5.0;
	VanetRoutingExperiment::m_80211mode= 1;
	***/
  VanetRoutingExperiment::m_scenario = 2;
  VanetRoutingExperiment::SetupScenario();
}
int
main (int argc, char *argv[])
{
  PriorityRoutingExperiment experiment;
