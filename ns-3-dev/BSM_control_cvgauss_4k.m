...
filename_20n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_20node_cvgauss_4k_control.output2.csv';
filename_40n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_40node_cvgauss_4k_control.output2.csv';
filename_60n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_60node_cvgauss_4k_control.output2.csv';
filename_80n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_80node_cvgauss_4k_control.output2.csv';
filename_120n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_120node_cvgauss_4k_control.output2.csv';
filename_160n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_160node_cvgauss_4k_control.output2.csv';
filename_200n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_200node_cvgauss_4k_control.output2.csv';
...
figure('rend','painters','pos',[10 10 700 500]);plot(safety_range(1:7), lp_PDR(1:7),'-or');title('Control Packet Delivery Ratio vs Distance');xlabel('Distance (m)');ylabel('Packet Delivery Ratio');
hold on;
...
plot(safety_range(1:7), lp_PDR_200n(1:7),'-om');
...
plot(safety_range(1:7), hp_PDR_200n(1:7),'-.xm');
ylim([0.05 1.01]);
legend('20 nodes-Risk Scheme-Safe Nodes','40 nodes-Risk Scheme-Safe Nodes','80 nodes--Risk Scheme-Safe Nodes',...
    '160 nodes--Risk Scheme-Safe Nodes','200 nodes--Risk Scheme-Safe Nodes','20 nodes-Risk Scheme-At Risk Nodes',...
    '40 nodes-Risk Scheme-At Risk Nodes','80 nodes-Risk Scheme-At Risk Nodes','120 nodes-Risk Scheme-At Risk Nodes',...
    '160 nodes-Risk Scheme-At Risk Nodes','200 nodes-Risk Scheme-At Risk Nodes');
...
figure('rend','painters','pos',[10 10 700 500]);plot(density, lp_PDR_SR_1,'-or');title('Control Packet Delivery Ratio vs Node Density');xlabel('Density(nodes/km)');ylabel('Packet Delivery Ratio');
hold on;
