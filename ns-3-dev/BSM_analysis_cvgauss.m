...
filename_20n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_20node_cvgauss.output2.csv';
filename_40n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_40node_cvgauss.output2.csv';
filename_60n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_60node_cvgauss.output2.csv';
filename_80n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_80node_cvgauss.output2.csv';
filename_120n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_120node_cvgauss.output2.csv';
filename_160n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_160node_cvgauss.output2.csv';
...
lp_PDR_SR_1=[lp_PDR(1) lp_PDR_40n(1) lp_PDR_80n(1) lp_PDR_120n(1) lp_PDR_160n(1)];
...
hp_PDR_SR_1=[hp_PDR(1) hp_PDR_40n(1) hp_PDR_80n(1) hp_PDR_120n(1) hp_PDR_160n(1)];
...
legend([num2str(safety_range(1)) ' m range-Risk Scheme-LP Nodes'], [num2str(safety_range(3)) ' m range-Risk Scheme-LP Nodes'], [num2str(safety_range(5)) ' m range-Risk Scheme-LP Nodes'], [num2str(safety_range(7)) ' m range-Risk Scheme-LP Nodes'], ...
[num2str(safety_range(1)) ' m range-Risk Scheme-HP Nodes'], [num2str(safety_range(3)) ' m range-Risk Scheme-HP Nodes'], [num2str(safety_range(5)) ' m range-Risk Scheme-HP Nodes'], [num2str(safety_range(7)) ' m range-Risk Scheme-HP Nodes']);


figure('rend','painters','pos',[10 10 700 500]);plot(density, hp_PDR_SR_1,'-or');title('High Priority Packet Delivery Ratio vs Node Density');xlabel('Density(nodes/km)');ylabel('Packet Delivery Ratio');
hold on;
...
ylim([0.05 1.01])
%legend('20 nodes-.1 sec beacon rate','40 nodes-.1 sec beacon rate','80 nodes-.1 sec beacon rate','160 nodes-.1 sec beacon rate','20 nodes-.05 sec beacon rate','40 nodes-.05 sec beacon rate','80 nodes-.05 sec beacon rate','160 nodes-.05 sec beacon rate');
legend([num2str(safety_range(1)) ' m range-Risk Scheme-HP Nodes'], [num2str(safety_range(3)) ' m range-Risk Scheme-HP Nodes'], [num2str(safety_range(5)) ' m range-Risk Scheme-HP Nodes'], [num2str(safety_range(7)) ' m range-Risk Scheme-HP Nodes'], ...
[num2str(safety_range(1)) ' m range-Control Scheme-HP Nodes'], [num2str(safety_range(3)) ' m range-Control Scheme-HP Nodes'], [num2str(safety_range(5)) ' m range-Control Scheme-HP Nodes'], [num2str(safety_range(7)) ' m range-Control Scheme-HP Nodes']);
