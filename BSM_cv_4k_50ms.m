...
figure('rend','painters','pos',[10 10 700 500]);plot(safety_range(1:7), lp_PDR(1:7),'-or');title('50 ms Adaptive Rate Packet Delivery Ratio vs Distance');xlabel('Distance (m)');ylabel('Packet Delivery Ratio');
hold on;
...
figure('rend','painters','pos',[10 10 700 500]);plot(density, lp_PDR_SR_1,'-or');title('50 ms Adaptive Rate Packet Delivery Ratio vs Node Density');xlabel('Density(nodes/km)');ylabel('Packet Delivery Ratio');
hold on;
