...
filename_20n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_20node_5sec_4k.output2.csv';
filename_40n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_40node_5sec_4k.output2.csv';
filename_60n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_60node_5sec_4k.output2.csv';
filename_80n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_80node_5sec_4k.output2.csv';
filename_160n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-beacon-rate/ns-3-dev/bsm_160node_5sec_4k.output2.csv';
delimiter = ',';
startRow = 2;
...
legend('20 nodes-Risk Scheme-Safe Nodes','40 nodes-Risk Scheme-Safe Nodes','80 nodes--Risk Scheme-Safe Nodes',...
    ...
    '80 nodes-Risk Scheme-At Risk Nodes','160 nodes-Risk Scheme-At Risk Nodes');

density=[20 40 80 160]./4;
[safety_range(1) safety_range(3) safety_range(5) safety_range(7)];
lp_PDR_SR_1=[lp_PDR(1) lp_PDR_40n(1) lp_PDR_80n(1) lp_PDR_160n(1)];
lp_PDR_SR_3=[lp_PDR(3) lp_PDR_40n(3) lp_PDR_80n(3) lp_PDR_160n(3)];
lp_PDR_SR_5=[lp_PDR(5) lp_PDR_40n(5) lp_PDR_80n(5) lp_PDR_160n(5)];
lp_PDR_SR_7=[lp_PDR(7) lp_PDR_40n(7) lp_PDR_80n(7) lp_PDR_160n(7)];

hp_PDR_SR_1=[hp_PDR(1) hp_PDR_40n(1) hp_PDR_80n(1) hp_PDR_160n(1)];
hp_PDR_SR_3=[hp_PDR(3) hp_PDR_40n(3) hp_PDR_80n(3) hp_PDR_160n(3)];
hp_PDR_SR_5=[hp_PDR(5) hp_PDR_40n(5) hp_PDR_80n(5) hp_PDR_160n(5)];
hp_PDR_SR_7=[hp_PDR(7) hp_PDR_40n(7) hp_PDR_80n(7) hp_PDR_160n(7)];
